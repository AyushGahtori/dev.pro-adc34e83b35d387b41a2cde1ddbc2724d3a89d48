        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="ayushgahtori24@gmail.com"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>gahtoriayush24@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              <a
                ...
                rel="noreferrer"
              >
                <Icon icon="simple-icons:" color="#666" />
              ...
              <a
                href="https://github.com/AyushGahtori"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className="space-y-3 ">
            <h4 className="text-body-1 font-semibold 2xl:text-4xl">"Let's create something buetiful...."</h4>
            <div className="space-y-2 text-body-2 2xl:text-3xl">
              <p style={{ opacity: 0 /* Set opacity to 0 */ }}>
